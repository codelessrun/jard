...
var rootCmd = &cobra.Command{
	Use:   "jard",
	Short: "An easy-to-use jar package deployment tool",
...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.jard.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".jard" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".jard")
	}
